...
class PluginMetadata:
    ...
    def get_config_schema(self, config_key: str | None = None) -> dict[str, Any]: ...
...
class Plugin:
    ...
    def register_schema(self, path: str | tuple[str, ...] = "", fragment: dict | type | Callable[[dict], dict] | None = None, *, replace: bool = False) -> None: ...
